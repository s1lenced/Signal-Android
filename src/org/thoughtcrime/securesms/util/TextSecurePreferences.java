...
public class TextSecurePreferences {
    ...
    public static final String IS_ADMIN = "pref_user_admin";
    ...
    public static boolean isAdmin(@NonNull Context context) {
        return getBooleanPreference(context, IS_ADMIN, false);
    }

    public static void setIsAdmin(@NonNull Context context, boolean value) {
        setBooleanPreference(context, IS_ADMIN, value);
    }
    ...
    String getRegistrationLockPin(@NonNull Context context) {
    ...
    public static @Nullable
    String getRegistrationToken(@NonNull Context context) {
        return getStringPreference(context, TOKEN, null);
    }

    public static void setRegistrationToken(@NonNull Context context, String token) {
        setStringPreference(context, TOKEN, token);
    }
    ...
    public static @Nullable
    String getBackupPassphrase(@NonNull Context context) {
    ...
    public static @NonNull
    Uri getCallNotificationRingtone(Context context) {
