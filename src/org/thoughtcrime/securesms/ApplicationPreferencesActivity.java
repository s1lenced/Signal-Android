...
import org.thoughtcrime.securesms.preferences.AdminPanelFragment;
...
public class ApplicationPreferencesActivity extends PassphraseRequiredActionBarActivity
    ...
    private static final String PREFERENCE_CATEGORY_ADMIN_PANEL = "preference_category_admin_panel";
    ...
    public static class ApplicationPreferenceFragment extends CorrectedPreferenceFragment {
        ...
        public void onCreate(Bundle icicle) {
            ...
            this.findPreference(PREFERENCE_CATEGORY_ADMIN_PANEL)
                    .setOnPreferenceClickListener(new CategoryClickListener(PREFERENCE_CATEGORY_ADMIN_PANEL));
        ...
        private void tintIcons(Context context) {
            ...
            Drawable adminPanel = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.ic_person_white_24dp));
            ...
            DrawableCompat.setTint(adminPanel, color);
            ...
            this.findPreference(PREFERENCE_CATEGORY_ADMIN_PANEL).setIcon(adminPanel);
        }
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                switch (category) {
                    case PREFERENCE_CATEGORY_SMS_MMS:
                        ...
                        break;
                    case PREFERENCE_CATEGORY_ADMIN_PANEL:
