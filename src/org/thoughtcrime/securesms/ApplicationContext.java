...
import org.thoughtcrime.securesms.registerService.AuthUtils;
...
public class ApplicationContext extends MultiDexApplication implements DependencyInjector, DefaultLifecycleObserver {
    ...
    public String getToken() {
        return mAuthUtils.getToken();
    }

    public void setToken(String token) {
        mAuthUtils.setToken(token);
    }
    ...
    private void initializeAuthUtils() {
        ...
        OkHttpClient client = new OkHttpClient.Builder()
                .addInterceptor(chain -> {
                    ...
                    Request.Builder requestBuilder = request.newBuilder()
                            .url(url);
                    if (mAuthUtils.getToken() != null) {
                        requestBuilder.addHeader("Authorization", mAuthUtils.getToken());
                    }
