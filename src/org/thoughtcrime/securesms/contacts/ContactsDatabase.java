...
public class ContactsDatabase {
    ...
    @SuppressLint("Recycle")
    public @NonNull
    Cursor queryTextSecureContacts(String filter) {
    ...
    public @Nullable
    Cursor getNameDetails(long contactId) {
    ...
    public @Nullable
    String getOrganizationName(long contactId) {
    ...
    public @Nullable
    Cursor getPhoneDetails(long contactId) {
    ...
    public @Nullable
    Cursor getEmailDetails(long contactId) {
    ...
    public @Nullable
    Cursor getPostalAddressDetails(long contactId) {
    ...
    public @Nullable
    Uri getAvatarUri(long contactId) {
    ...
    private @NonNull
    Map<Address, SignalContact> getSignalRawContacts(@NonNull Account account) {
        Uri currentContactsUri = RawContacts.CONTENT_URI.buildUpon()
                .appendQueryParameter(RawContacts.ACCOUNT_NAME, account.name)
    ...
    private @Nullable
    String getDisplayName(long contactId) {
